export const ThemeJson = {
    ...
    title: "Orange Agent Theme",
    description: "Theme schema for Orange agent",
    type: "object",
    ...
    properties: {
                ...
                oneOf: [
                    {
                        type: "string",
                        description:
                            "Hex color (#RRGGBB), variable reference, or empty string for terminal default",
                    },
                    {
                        type: "integer",
                        minimum: 0,
        ...
        export: {
            type: "object",
            description:
                "Optional colors for HTML export (defaults derived from userMessageBg if not specified)",
            properties: {
                pageBg: {
                    $ref: "#/$defs/colorValue",
