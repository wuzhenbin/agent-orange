...
import { type CompactionResult } from "./harness/compaction.ts"
...
export interface AgentLoopConfig extends SimpleStreamOptions {
     ...
     * - 上下文窗口管理(修剪旧消息) Context window management (pruning old messages)
     * - 从外部来源注入上下文 Injecting context from external sources
     *
